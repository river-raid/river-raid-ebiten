...
var SpriteExplosions = [3]Sprite{
	...
	}, SpriteExplosionWidth, SpriteExplosionHeight),
	newSprite([]byte{
...
var SpriteRocks = [4]Sprite{
	...
	}, spriteRockWidth, spriteRockHeight),
	newSprite([]byte{
...
var SpriteShellExplosions = [6]Sprite{
	newSprite([]byte{
		...
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}, SpriteExplosionWidth, spriteShellExplosionHeight),
	newSprite([]byte{
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
var SpriteObjects = [8]Sprite{
	...
	domain.ObjectFighter: newSprite([]byte{
		0x00, 0x00, 0x00, 0x40, 0x70, 0xc0, 0xff, 0xc0,
	...
	// Fuel depot sprite, from $8A86, pixels shifted 3px left.
	domain.ObjectFuel: newSprite([]byte{
		0x7f, 0x80, 0x61, 0x80, 0x6f, 0x80, 0x63, 0x80,
		0x6f, 0x80, 0x6f, 0x80, 0x7f, 0x80, 0x6d, 0x80,
		0x6d, 0x80, 0x6d, 0x80, 0x6d, 0x80, 0x73, 0x80,
		0x7f, 0x80, 0x61, 0x80, 0x6f, 0x80, 0x63, 0x80,
		0x6f, 0x80, 0x61, 0x80, 0x7f, 0x80, 0x6f, 0x80,
		0x6f, 0x80, 0x6f, 0x80, 0x6f, 0x80, 0x61, 0x80,
		0x7f, 0x80,
...
}, SpritePlayerMissileWidth, SpritePlayerMissileHeight)
