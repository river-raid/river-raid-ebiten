...
func TestMoveFighter_WrapsLeft(t *testing.T) {
	...
	slot := Slot{X: 2, Orientation: OrientationLeft, Activated: true}
	moveFighter(&slot)
...
func TestMoveFighter_WrapsRight(t *testing.T) {
	...
	slot := Slot{X: 232, Orientation: OrientationRight, Activated: true}
	moveFighter(&slot)
...
func TestMoveShipOrHelicopter_EvenTickOnly(t *testing.T) {
	...
	slot := Slot{X: 100, Orientation: OrientationRight, Activated: true}
